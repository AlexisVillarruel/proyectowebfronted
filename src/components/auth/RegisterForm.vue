    ...
    <div class="content">
      <form action="#">
        <div class="user-details">
          ...
          <div class="input-box">
            <span class="details">Imagen Usuario (URL)</span>
            <input
              type="text"
              v-model="imagenUsuario"
        ...
        <div class="button">
          <input type="submit" value="Register" @click="Registro" />
        </div>
      </form>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    Registro() {
      let URL = "http://localhost:5290/api/Usuarios";
      let usuarios = {
        nombre: this.nombre,
